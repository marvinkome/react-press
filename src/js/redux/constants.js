...
export const REQUEST_EDIT_POST_FINISHED =
    'REQUEST_EDIT_POST_FINISHED';
export const REQUEST_DELETE_POST_FINISHED =
    'REQUEST_DELETE_POST_FINISHED';
export const REQUEST_USER_EDIT_FINISHED =
    'REQUEST_USER_EDIT_FINISHED';

// Post interaction
export const REQUEST_COMMENT_FINISHED = 'REQUEST_COMMENT_FINISHED';
export const REQUEST_COMMENT_REPLY_FINISHED =
    'REQUEST_COMMENT_REPLY_FINISHED';

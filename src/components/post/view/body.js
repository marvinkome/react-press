                            ...
                            <ul className="collection">
                                <li className="collection-item avatar">
                                    ...
                                    <div className="comment-resp">
                                        Thank you, Kevin, this article was
                                        created just for me! ( lol). I am new to
                                        coding, teaching myself, HTML/CSS and
                                        Javascript. I’ve just enough knowledge
                                        to fully understand your article and I
                                        appreciate you taking the time to write
                                        this. My goal is to become both a front
                                        and back-end developer. Articles like
                                        this one, along with many other
                                        resources…
                                    </div>

...
export class Body extends Component {
    ...
    onClap = async () => {
        ...
        if (user.data !== undefined && post !== undefined) {
            ...
            try {
                ...
                createToast('Oopps there\'s an error');
            }
        } else {
            createToast('You must be logged in to clap');
    ...
    onCommentReply = async (comment, parent_id) => {
        ...
        if (user.data != undefined && post != undefined) {
            ...
            createToast('You must be logged in to reply to comment');
        }
    };
